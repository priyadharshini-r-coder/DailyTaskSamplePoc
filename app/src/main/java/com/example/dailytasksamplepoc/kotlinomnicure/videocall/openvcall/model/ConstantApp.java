...
public class ConstantApp {
    ...
    private static final VideoEncoderConfiguration.VideoDimensions[] VIDEO_DIMENSIONS = new VideoEncoderConfiguration.VideoDimensions[] {
    ...
    private static final VideoEncoderConfiguration.FRAME_RATE[] VIDEO_FPS = new VideoEncoderConfiguration.FRAME_RATE[] {
    ...
    public static final int DEFAULT_VIDEO_ENC_RESOLUTION_IDX = 4; // default use 720P
    ...
    public static VideoEncoderConfiguration.FRAME_RATE[] getVideoFps() {
        return VIDEO_FPS;
    }
